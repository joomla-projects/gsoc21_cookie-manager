 ...
 * @since  1.6
 */
class CookiemanagerController extends AdminController
{
	/**
	 * Proxy for getModel.
	 *
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Cookiemanager', $prefix = 'Administrator', $config = array('ignore_request' => true))
	{
