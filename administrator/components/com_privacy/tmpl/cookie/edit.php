...
<form action="<?php echo Route::_('index.php?option=com_privacy&layout=edit&id=' . (int) $this->item->id); ?>" method="post"  class="form-validate"
    name="adminForm" id="cookie-form" aria-label="<?php echo Text::_('COM_PRIVACY_FORM_TITLE_' . ((int) $this->item->id === 0 ? 'NEW_COOKIE' : 'EDIT_COOKIE'), true); ?>">
    ...
    <div class="main-card">
        ...
        <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'details', Text::_('COM_PRIVACY_COOKIES')); ?>
        <div class="row">
            <div class="col-lg-9">
