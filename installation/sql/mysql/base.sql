...
(1, '', 'Menu_Item_Root', 'root', '', '', '', '', 1, 0, 0, 0, 0, 0, '', 0, '', 0, 53, 0, '*', 0, NULL, NULL);
...
INSERT INTO `#__menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`, `publish_up`, `publish_down`)
SELECT 22, 'main', 'com_cookiemanager', 'Cookiemanager', '', 'Cookiemanager', 'index.php?option=com_cookiemanager', 'component', 1, 1, 1, `extension_id`, 0, 1, 'class:cookie', 0, '', 41, 50, 0, '*', 1, NULL, NULL FROM `#__extensions` WHERE `name` = 'com_cookiemanager';
INSERT INTO `#__menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`, `publish_up`, `publish_down`)
SELECT 23, 'main', 'com_cookiemanager_cookies', 'Cookies', '', 'Cookiemanager/Cookies', 'index.php?option=com_cookiemanager&view=cookies', 'component', 1, 22, 2, `extension_id`, 0, 1, 'class:cookie', 0, '', 42, 43, 0, '*', 1, NULL, NULL FROM `#__extensions` WHERE `name` = 'com_cookiemanager';
INSERT INTO `#__menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`, `publish_up`, `publish_down`)
SELECT 24, 'main', 'com_cookiemanager_categories', 'Categories', '', 'Cookiemanager/Categories', 'index.php?option=com_categories&view=categories&extension=com_cookiemanager', 'component', 1, 22, 2, `extension_id`, 0, 1, 'class:cookies-cat', 0, '', 44, 45, 0, '*', 1, NULL, NULL FROM `#__extensions` WHERE `name` = 'com_categories';
INSERT INTO `#__menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`, `publish_up`, `publish_down`)
SELECT 25, 'main', 'com_cookiemanager_scripts', 'Scripts', '', 'Cookiemanager/Scripts', 'index.php?option=com_cookiemanager&view=scripts', 'component', 1, 22, 2, `extension_id`, 0, 1, 'class:code', 0, '', 46, 47, 0, '*', 1, NULL, NULL FROM `#__extensions` WHERE `name` = 'com_cookiemanager';
INSERT INTO `#__menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`, `publish_up`, `publish_down`)
SELECT 26, 'main', 'com_cookiemanager_consents', 'Consents', '', 'Cookiemanager/Consents', 'index.php?option=com_cookiemanager&view=consents', 'component', 1, 22, 2, `extension_id`, 0, 1, 'class:lock', 0, '', 48, 49, 0, '*', 1, NULL, NULL FROM `#__extensions` WHERE `name` = 'com_cookiemanager';
INSERT INTO `#__menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`, `publish_up`, `publish_down`)
